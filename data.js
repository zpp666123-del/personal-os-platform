(function () {
  ...
  const SEED_DB = {
    ...
    leads: [
      { id: 'lead_001', profileId: 'profile_cj', name: '示例访客', email: 'partner@example.com', intent: '项目合作', message: '我想了解是否可以基于这套主页模板为我们社群成员批量生成个人能力页。', createdAt: '2026-06-29T09:30:00.000Z' }
    ]
  };
